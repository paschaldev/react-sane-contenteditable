...
var propTypes = {
  ...
  sanitise: _propTypes.default.bool,
  caretPosition: _propTypes.default.oneOf(['start', 'end']),
  ...
  styled: _propTypes.default.bool // If element is a styled component (uses innerRef instead of ref)
...
function (_Component) {
  ...
  _createClass(ContentEditable, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      var propKeys = (0, _lodash.without)(Object.keys(nextProps), 'content');
    ...
    value: function render() {
      ...
      return _react.default.createElement(Element, _extends({}, (0, _lodash.omit)(props, Object.keys(propTypes)), styled ? {
